...
class AppTextTheme {
  static TextTheme lightTextTheme = const TextTheme(
    ...
    titleSmall: TextStyle(color: Colors.black, fontFamily: 'Epilogue', fontWeight: FontWeight.bold),
    titleMedium: TextStyle(color: Colors.black, fontFamily: 'Epilogue', fontWeight: FontWeight.bold),
    titleLarge: TextStyle(color: Colors.black, fontFamily: 'Epilogue', fontWeight: FontWeight.bold),
    ...
    titleSmall: TextStyle(color: Colors.white, fontFamily: 'Epilogue', fontWeight: FontWeight.bold),
    titleMedium: TextStyle(color: Colors.white, fontFamily: 'Epilogue', fontWeight: FontWeight.bold),
    titleLarge: TextStyle(color: Colors.white, fontFamily: 'Epilogue', fontWeight: FontWeight.bold),
